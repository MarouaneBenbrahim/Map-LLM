...
// Secondary cables
    ...
    function updateTime() {
        ...
        // If scenario time is set, display that instead of real-world time
        if (window.llmScenarioHandler && window.llmScenarioHandler.currentTime !== undefined) {
            const scenarioHour = window.llmScenarioHandler.currentTime;
            const formattedTime = String(scenarioHour).padStart(2, '0') + ':00';
